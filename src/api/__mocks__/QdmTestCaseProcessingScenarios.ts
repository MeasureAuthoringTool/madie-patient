...
export const CV_EPISODE_WITH_STRAT_OBS_RESULTS: QdmTestCaseProcessingScenario =
  {
    ...
    testCase: {
      id: "6581e07fcb2d940f11208ab8",
      name: null,
      title: "MultipleEDandInpt1WithPrinicipal",
      series: "MSRPOPLStrat1Strat2Pass",
      description:
        "Has principal psych dx in IP encounter; ED less than 1 hour to inpt; decision to admit concurrent with departure from ED; No principal dx enc 2 ",
      createdAt: "2023-12-19T18:27:11.425Z",
      createdBy: "rohit.kandimalla@semanticbits.com",
      lastModifiedAt: "2023-12-19T18:27:11.425Z",
      lastModifiedBy: "rohit.kandimalla@semanticbits.com",
      validResource: true,
      json: "{}",
      patientId: "b18db6b2-68f9-4684-8e39-6210da44fb79",
      hapiOperationOutcome: null,
      groupPopulations: [
        {
          groupId: "6580be5706cbc160f5750a29",
          scoring: "Continuous Variable",
          populationBasis: "false",
          populationValues: [
            {
              id: "b846e25b-8852-4a25-b2e7-579b0862b7d1",
              criteriaReference: null,
              name: PopulationType.INITIAL_POPULATION,
              expected: 2,
              actual: null,
            ...
            {
              id: "447f2e95-7dd3-4a90-b30b-76b4b1e92429",
              criteriaReference: null,
              name: PopulationType.MEASURE_POPULATION,
              expected: 2,
              actual: null,
            ...
            {
              id: "f7e4b44e-4cfa-49cf-8f84-3ad24a0593b7",
              criteriaReference: null,
              name: PopulationType.MEASURE_POPULATION_EXCLUSION,
              expected: 0,
              actual: null,
          ...
          stratificationValues: [
            {
              id: "f3aeeeca-f093-40f2-9455-c49cd01dc4da",
              name: "Strata-1",
              expected: 1,
              actual: null,
              populationValues: [
                {
                  id: "3ccd7e36-2db1-4d14-a52d-78e1f0d6fd64",
                  criteriaReference: null,
                  name: PopulationType.INITIAL_POPULATION,
                  expected: 1,
                  actual: null,
                ...
                {
                  id: "6faee668-3ae9-43bb-b7c7-c7340980f37d",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION_OBSERVATION,
                  expected: 60,
                  actual: null,
                ...
                {
                  id: "aa2180a6-b9f6-46c7-9bf6-6207d43b29ca",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION,
                  expected: 1,
                  actual: null,
                ...
                {
                  id: "4d462470-f459-468c-b500-5347343c72d6",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION_EXCLUSION,
                  expected: 0,
                  actual: null,
            ...
            {
              id: "e2ffe802-2a88-417c-8415-9388214d3239",
              name: "Strata-2",
              expected: 1,
              actual: null,
              populationValues: [
                {
                  id: "be3d4839-4e8e-433d-95f5-f3eaf9bc91e6",
                  criteriaReference: null,
                  name: PopulationType.INITIAL_POPULATION,
                  expected: 1,
                  actual: null,
                ...
                {
                  id: "b737d6e6-2190-43fb-8d65-1c2c75c80b27",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION_OBSERVATION,
                  expected: 5,
                  actual: null,
                ...
                {
                  id: "1b409371-d572-4805-abe1-54662785db22",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION,
                  expected: 1,
                  actual: null,
                ...
                {
                  id: "b34af98b-ca6e-44d5-9524-b16d2829545c",
                  criteriaReference: null,
                  name: PopulationType.MEASURE_POPULATION_EXCLUSION,
                  expected: 0,
                  actual: null,
    ...
    measureGroups: [
      {
        ...
        populations: [
          ...
          },
          {
            id: "f7e4b44e-4cfa-49cf-8f84-3ad24a0593b7",
            name: PopulationType.MEASURE_POPULATION_EXCLUSION,
            definition: "Measure Population Exclusions",
            associationType: null,
            description: "",
          },
        ],
        measureObservations: [
          {
            id: "90abcf4e-893c-4a4f-89eb-aaff2194a8d7",
            definition: "MeasureObservation",
            description: null,
            criteriaReference: "447f2e95-7dd3-4a90-b30b-76b4b1e92429",
            aggregateMethod: AggregateFunctionType.COUNT,
          },
        ],
        groupDescription: "",
        ...
        stratifications: [
          {
            id: "1b1dc434-1256-4640-8747-a370e62b6b96",
            description: "",
            cqlDefinition: "Stratification 1",
            association: null,
          },
          {
            id: "58eeea8b-86f2-471d-91c3-9f3fe276c4e9",
            description: "",
    ...
    patientResults: {
      "6580be5706cbc160f5750a29": {
        IPP: 2,
        observation_values: [60, 5],
        MSRPOPL: 2,
        MSRPOPLEX: 0,
        episode_results: {
          "5ce55585b8484631cfbc61f7": {
            IPP: 1,
            MSRPOPL: 1,
            MSRPOPLEX: 0,
            observation_values: [60],
          },
          "5ce55585b8484631cfbc61fb": {
            IPP: 1,
            MSRPOPL: 1,
            MSRPOPLEX: 0,
        ...
        patient: "6581e07e018e7900005cd39a",
        measure: "65955b40369c1d0000db60d4",
        state: "complete",
      },
        ...
        statement_results: {
          QdmEpisodeRatio1: {
              ...
              raw: [
                {
                  ...
                  description:
                    "Encounter, Performed: Emergency Department Visit",
                  codeListId: "2.16.840.1.113883.3.117.1.7.1.292",
                  id: "6540f0cad9f99000000a50d5",
                  relevantPeriod: {
                    low: "2024-01-11T00:00:00.000+00:00",
                    high: "2024-01-23T00:00:00.000+00:00",
                    lowClosed: true,
                    highClosed: true,
                  },
                  facilityLocations: [],
                  diagnoses: [
                    {
                      ...
                      _id: "6540f388d9f99000000a50fc",
                      code: {
                        code: "34921009",
                        system: "2.16.840.1.113883.6.96",
                        version: null,
                        display:
                          "Acute peptic ulcer with perforation but without obstruction (disorder)",
                      },
                ...
                },
                {
                  ...
                  description:
                    "Encounter, Performed: Emergency Department Visit",
                  codeListId: "2.16.840.1.113883.3.117.1.7.1.292",
                  id: "654275f7fb870d00005a0a35",
                  relevantPeriod: {
                    low: "2024-06-09T04:00:00.000+00:00",
                    high: "2024-06-28T00:00:00.000+00:00",
                    lowClosed: true,
                    highClosed: true,
                  },
                  facilityLocations: [],
                ...
                },
                {
                  dataElementCodes: [
                    {
                      ...
                      version: null,
                      display: "Vascular dementia, mild, with agitation",
                    },
                  ],
                  _id: "6540f087d9f99000000a50b4",
                  participant: [],
                  relatedTo: [],
                  qdmTitle: "Encounter, Performed",
                  hqmfOid: "2.16.840.1.113883.10.20.28.4.5",
                  ...
                  qdmVersion: "5.6",
                  _type: "QDM::EncounterPerformed",
                  description: "Encounter, Performed: Dementia",
                  codeListId: "2.16.840.1.113883.3.3157.4043",
                  id: "6540f09cd9f99000000a50bf",
                  relevantPeriod: {
                    low: "2023-12-30T00:00:00.000+00:00",
                    high: "2024-01-03T00:00:00.000+00:00",
                    lowClosed: true,
                    highClosed: true,
                  },
                  facilityLocations: [],
                ...
                },
                {
                  dataElementCodes: [
                    {
                      ...
                      version: null,
                      display:
                        "Behavioral disturbance co-occurrent and due to late onset Alzheimer dementia (disorder)",
                    },
                  ],
                  _id: "65423e83a168f90000f0d2ae",
                  participant: [],
                  relatedTo: [],
                  qdmTitle: "Encounter, Performed",
                  hqmfOid: "2.16.840.1.113883.10.20.28.4.5",
                  ...
                  description: "Encounter, Performed: Dementia",
                  codeListId: "2.16.840.1.113883.3.3157.4043",
                  id: "65423e86a168f90000f0d2c0",
                  relevantPeriod: {
                    low: "2024-04-16T00:00:00.000+00:00",
                    high: "2024-04-22T00:00:00.000+00:00",
                    lowClosed: true,
                    highClosed: true,
                  },
                  facilityLocations: [],
            ...
            "Denoninator Exclusion": {
              ...
              library_name: "QdmEpisodeRatio1",
              statement_name: "Denoninator Exclusion",
              relevance: "TRUE",
              final: "TRUE",
            },
            Numerator: {
            ...
            denomObs: {
              library_name: "QdmEpisodeRatio1",
              statement_name: "denomObs",
              relevance: "TRUE",
              final: "FALSE",
            },
            numerObs: {
              library_name: "QdmEpisodeRatio1",
              statement_name: "numerObs",
              relevance: "TRUE",
              final: "FALSE",
            },
            IP2: {

import { PopulationType, GroupPopulation } from "@madie/madie-models";
...
it("Doesn't need to do anything because the rest of the tests will be updated in a future PR", () => {
  expect(true).toBeTruthy;
});
// it("return the input matches output with no changes", () => {
//   const populationVal: Population = {
